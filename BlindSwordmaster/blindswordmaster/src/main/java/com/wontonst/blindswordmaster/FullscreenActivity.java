...
//        gestureDetector.startDetecting();
        ...
        soundManager.playSoundOnce(GameSound.BEGIN);
        try {
            Thread.sleep(3000);
        } catch(InterruptedException ex) {
            Thread.currentThread().interrupt();
        }
        soundManager.playSoundOnce(GameSound.HIT);
        try {
            Thread.sleep(1000);
        } catch(InterruptedException ex) {
            Thread.currentThread().interrupt();
        }
        soundManager.playSoundOnce(GameSound.LEFT_HIT);
        try {
            Thread.sleep(500);
        } catch(InterruptedException ex) {
            Thread.currentThread().interrupt();
        ...
        soundManager.playSoundOnce(GameSound.RIGHT_HIT);
        try {
            Thread.sleep(600);
        } catch(InterruptedException ex) {
            Thread.currentThread().interrupt();
        }
        soundManager.playSoundOnce(GameSound.LEFT_SLASH);
        try {
            Thread.sleep(300);
        } catch(InterruptedException ex) {
            Thread.currentThread().interrupt();
        }
        soundManager.playSoundOnce(GameSound.RIGHT_SLASH);
        try {
            Thread.sleep(100);
        } catch(InterruptedException ex) {
            Thread.currentThread().interrupt();
        }
        soundManager.playSoundOnce(GameSound.CENTER);
        try {
            Thread.sleep(500);
        } catch(InterruptedException ex) {
            Thread.currentThread().interrupt();
        ...
        soundManager.playSoundOnce(GameSound.MOVE_FORWARD);
        try {
            Thread.sleep(100);
        } catch(InterruptedException ex) {
            Thread.currentThread().interrupt();
